...
Examples =
{
	...
	fountain :
	{
		...
		particleTexture : THREE.ImageUtils.loadTexture( 'assets/img/star.png' ),
...
*/
	...
	{
		positionStyle  : Type.SPHERE,
		positionBase   : new THREE.Vector3( 5, 5, 5 ),
		positionRadius : 5,
		...
		particleTexture : THREE.ImageUtils.loadTexture( 'assets/img/spark.png' ),
