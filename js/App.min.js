...
App.rebuildSkyBox = {changeBackground: function (a) {
    ...
    a = [];
    for (var c = 0; 6 > c; c++) {
        var d = new THREE.MeshBasicMaterial({map: THREE.ImageUtils.loadTexture('assets/'+b[c]), side: THREE.BackSide});
        a.push(d)
    }
...
function init() {
    ...
    b = "img/dawnmountain-xpos.png img/dawnmountain-xneg.png img/dawnmountain-ypos.png img/dawnmountain-yneg.png img/dawnmountain-zpos.png img/dawnmountain-zneg.png".split(" ");
    c = [];
    for (a = 0; 6 > a; a++)c.push(new THREE.MeshBasicMaterial({map: THREE.ImageUtils.loadTexture('assets/'+b[a]), side: THREE.BackSide}));
